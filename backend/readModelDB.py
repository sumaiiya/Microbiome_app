...
sys.path.append(os.path.join(script_dir, "MICROBIOME_APP"))
#from mainClasses import *
#from simulation_envs.scripts.core.mainClasses import *
from mainClasses import Metabolite, Metabolome, FeedingTerm, Subpopulation, Bacteria
